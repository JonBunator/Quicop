...
contextBridge.exposeInMainWorld("electronAPI", {
	...
	onRefreshCodeFiles: (func: (...args: unknown[]) => void) => ipcRenderer.on('onRefreshCodeFiles', func),
	removeAllImportCodeFileFolderListeners: () => ipcRenderer.removeAllListeners('onImportCodeFileFolder'),
	removeAllImportCodeFileListeners: () => ipcRenderer.removeAllListeners('onImportCodeFile'),
	removeAllRefreshCodeFilesListeners: () => ipcRenderer.removeAllListeners('onRefreshCodeFiles'),
